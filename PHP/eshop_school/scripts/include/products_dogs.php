<!--view the dog products and put them to cart-->  
<table>
<tbody>
   <tr>
...
<?php
    ...
    $box=0;
        ...
        {
            //takes data from product if category is dog
            $query = "SELECT product_id,name,category,description,photograph,store,price FROM product WHERE category='dog' ";
    ...
    <td id="index_box2">     
     <form name="add_cart"  action="scripts/add_to_cart.php" method="POST">
            ...
            <font id="product_form">
                ...
                <?php  if($box==2){echo '</tr>'; $box=0; }else {$box++;}  } ?>
                        <?php 
