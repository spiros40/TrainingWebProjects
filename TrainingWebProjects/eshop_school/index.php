         ...
         <tr>
           ...
           <td style="width: 500px; height: 200px;"> <div style="margin-left: 1px;">
               ...
               <tr> 
                   ...
                   <td <img src="pics/account.png" style="height:30px; width:30px" />
                    <?php 
...
<body>
    ...
    <!-- Banner -->
    <div id="banner1"> <a href="#"><img id="banner_img" src="pics/banner.gif" alt="banner" /></a></div>
    ...
    <table id="main_table">
        <tr><td><h2><b>Τελευταίες αφίξεις</b></h2></td></tr>
        
        <?php include 'scripts/include/products.php';?> 

        <tr><td style="border-style: none"><h2 style="border-collapse: separate"><b>Δημοφιλή προϊόντα</b></h2></td></tr>
